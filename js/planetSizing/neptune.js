$(".neptunePictureHolderMob").click(function() {
    console.log("Neptuneclicked");
    
    $(".planetImageHolder").find("img").fadeTo(0, 1);
         if($(".NeptuneImage").hasClass("enlarged")){
            $(".NeptuneImage").removeClass("enlarged");
            $(".imagePositionerMob").stop().animate({width: '25vw', height:'25vw'}, 2000 );
            $(".NeptuneImage").stop().animate({width: '25vw', height:'25vw'}, 2000,
            function(){
            ...
            $(".NeptuneImage").addClass("enlarged")
            ...
            1;
            var sizeInCm = (sessionStorage.getItem("dpi")/dppx)*1.925197;
            $(this).parent().addClass('ontop');
            $(".NeptuneImage").stop().animate({width: sizeInCm, height:sizeInCm}, 2000 );
            $(".imagePositionerMob").stop().animate({height:sizeInCm}, 2000 );
         }
 
 });

 $(".neptunePictureHolder").click(function() {
    console.log("Neptuneclicked");
    ...
    $(".planetImageHolder").find("img").fadeTo(0, 1);
         if($(".NeptuneImage").hasClass("enlarged")){
            ...
            $(".NeptuneImage").stop().animate({width: '150px', height:'150px'}, 2000,
            function(){
                $(this).parent().removeClass('ontop');
            }); /*so it gets put on bottom AFTER the shrink animation is finished*/
           
            setTimeout(function(){ $(".NeptuneImage").removeClass("enlarged");},2100);
